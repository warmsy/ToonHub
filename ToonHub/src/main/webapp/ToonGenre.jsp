				...
				<section class="tabArea">
					<div class="tabBox on">
						<div id="grid" class="grid clearfix">
							...
							<nav class="toon1">
								<strong>#로맨스</strong><a href="GenreAll_romance.jsp" class="main_more">더보기
									></a><br>
								<br>
						...
						<nav class="toon1">
								<strong># 드라마</strong><a href="GenreAll_drama.jsp" class="main_more">더보기
									></a><br>
								<br>
								<div class="toon_slider_box">
								<div class="brands">
						...
						<nav class="toon1">
								<strong># 액션</strong><a href="GenreAll_action.jsp" class="main_more">더보기
									></a><br>
								<br>
								<div class="toon_slider_box">
								<div class="brands">
						...
						<nav class="toon1">
								<strong># 판타지</strong><a href="GenreAll_fantasy.jsp" class="main_more">더보기
									></a><br>
								<br>
								<div class="toon_slider_box">
								<div class="brands">
						...
						<nav class="toon1">
								<strong># 옴니버스</strong><a href="GenreAll_omnibus.jsp" class="main_more">더보기
									></a><br>
								<br>
								<div class="toon_slider_box">
								<div class="brands">
						...
						<nav class="toon1">
								<strong># 개그</strong><a href="GenreAll_gag.jsp" class="main_more">더보기
									></a><br>
								<br>
								<div class="toon_slider_box">
								<div class="brands">
