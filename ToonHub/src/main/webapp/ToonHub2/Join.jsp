		...
		<div class="container">
			<div class="content">
				...
				<div class = "join_information">
					<input class="information" type="text" placeholder="EMAIL" required="required">
					<input class="information" type="text" placeholder="NICKNAME" required="required">
					<input class="information" id = "password" type="password" placeholder="Password" required="required">
					<i class="fa fa-eye fa-lg"></i>
					<input class="information" id = "password_check" type="password" placeholder="Password CHECK">
				</div>
