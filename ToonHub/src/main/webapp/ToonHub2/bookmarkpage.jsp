	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.css">
		...
		<div class="container">
			...
			<div class="content">
                ...
                <div class ="bookmark_all" style="color: #616161;">
                    <div class = "cont_head">
                        <div class = "cont_header">
                        <strong>추천해요</strong></div>
                        <div class = "cont_shortcut" style="margin-right: 10%;">
                        ...
                        <div class="items" >
                            <div >
                                <a href="detail.jsp">
                                    ...
                                    <div class = "info " style = "color: #616161!important";>
                                        <strong>제목</strong><br>
                                        <span>작가 이름</span><br>
                                    </div>
                                </a>
