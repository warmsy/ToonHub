		...
		<div class="container">
			...
			<div class="content">
                ...
                <div class ="platform">
                    ...
                    <ul><strong style="font-size: 20px;">탑툰</strong> <span>|</span><span>toptoon</span>
                    <div class = "viewall">
                    </div>
                    </ul>
                    </table>
                    ...
                    <div>
                        <div class="items" style="display: flex;flex-wrap: wrap; margin-left:3%;" >
                            ...
                            <%for(int i=0; i<toptoon.size() ; i++){ %>
                         
                             <%img= toptoon.get(i).getWebfile();%>
							<%img = img.replace("?", "");%>
							
                             <div style="margin: 10px;">
                                <a href="Detail_Platform.jsp?title=<%=toptoon.get(i).getWebtitle()%>" style="color: #616161!important;">
                                    <div style="width: 100px;height: 100px; background-color: #42C690;">
                                        <img src="./toon_image/<%=img%>" width="100px" height = "100px">
                                    </div>
                                    <div class = "info">
                                        <strong><%=toptoon.get(i).getWebtitle()%></strong><br>
                                        <span><%=toptoon.get(i).getWebwriter()%></span><br>
                                    </div>
                                </a>
                             </div><%}%>
