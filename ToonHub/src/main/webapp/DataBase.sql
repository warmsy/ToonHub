...
web_title varchar2(80) not null,
web_genre varchar2(20) not null,
web_view number not null,
web_writer varchar2(50) not null,
web_platform varchar2(10) not null,
web_day varchar2(20),
web_story varchar2(1500) not null,
...
alter table webtoon modify web_title varchar2(50);
alter table webtoon modify web_writer varchar2(50);

drop table webtoon cascade constraints;
drop table bookmark cascade constraints;
drop table review cascade constraints;
drop table recommand cascade constraints;

drop table webtoon_example;

create table Webtoon_example(
web_title varchar2(100) not null,
web_genre varchar2(20) not null,
web_view number not null,
web_writer varchar2(100) not null,
web_platform varchar2(10) not null,
web_day varchar2(20),
web_story varchar2(1500) not null,
web_file varchar2(100) not null,
